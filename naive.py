...
def assign_ONU_to_splitters(splitters_positions, ONU_positions):
    """
    Przypisuje węzły ONU do najbliższych splitterów, uwzględniając pojemność splitterów.
...
def optimize_splitters_with_reassignment(OLT, ONU_positions, num_splitters, max_iter, max_stagnation):
...
def plot_network(OLT, splitters_positions, mst, ONU_positions, title):
...
def main():
    ...
    plot_network(OLT, splitters, mst, onus,"naive_fiber_network.png")
